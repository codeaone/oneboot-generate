...
import org.oneboot.core.mvc.format.MoneyJsonSerializer;
...
public class JacksonConfig {
	...
	public ObjectMapper jacksonObjectMapper() {
		...
		// ")引用字符串(名称和字符串值)的特性。如果是，这是除了其他可接受的标记。但不是JSON规范)。
...
//		javaTimeModule.addSerializer(String.class, new JacksonSensitiveFilter());
		javaTimeModule.addSerializer(Money.class, new MoneyJsonSerializer());
