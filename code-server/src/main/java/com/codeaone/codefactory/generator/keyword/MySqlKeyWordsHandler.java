...
public class MySqlKeyWordsHandler extends BaseKeyWordsHandler {
	...
	private static List<String> KEY_WORDS = new ArrayList<>(Arrays.asList("ACCESSIBLE", "ACCOUNT", "ACTION", "ADD",
			"AFTER", "AGAINST", "AGGREGATE", "ALGORITHM", "ALL", "ALTER", "ALWAYS", "ANALYSE", "ANALYZE", "AND", "ANY",
			"AS", "ASC", "ASCII", "ASENSITIVE", "AT", "AUTOEXTEND_SIZE", "AUTO_INCREMENT", "AVG", "AVG_ROW_LENGTH",
